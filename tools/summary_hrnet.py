...
def get_model_summary(model, *input_tensors, item_length=26, verbose=False):
    ...
    def add_hooks(module):
        ...
        def hook(module, input, output):
            ...
            if class_name.find("Conv2d") != -1 or class_name.find("ConvTranspose2d") != -1 or class_name.find("BatchNorm") != -1 or \
...
def main():
    ...
    print(get_model_summary(model, torch.zeros([1, 3, 256, 192])))
