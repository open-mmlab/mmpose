_base_ = ['../../../rtmpose/ubody/rtmpose-l_8xb64-270e_coco-ubody-wholebody-256x192.py']
...
model = dict(
    ...
    teacher_pretrained = 'https://download.openmmlab.com/mmpose/v1/projects/rtmposev1/rtmpose-x_ucoco_256x192-05f5bcb7_20230822.pth',
