dataset_info = dict(
    ...
    skeleton_info={
        ...
        12:
        dict(
            link=('right_shoulder', 'right_elbow'), id=12, color=[255, 128, 0]),
        13:
    ...
    sigmas=[0.026, 0.025, 0.025, 0.035, 0.035, 0.079, 0.079, 0.072, 0.072,
       0.062, 0.062, 0.107, 0.107, 0.087, 0.087, 0.089, 0.089, 0.08 ,
       0.08 , 0.08 , 0.089, 0.089, 0.089, 0.089, 0.089, 0.089, 0.015,
