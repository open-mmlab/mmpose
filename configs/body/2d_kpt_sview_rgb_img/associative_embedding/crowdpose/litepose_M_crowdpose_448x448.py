...
load_from = 'https://download.openmmlab.com/mmpose/pretrain_models/litepose_m_crowdpose-be7edcef_20220721.pth'  # noqa: E501
...
model = dict(
    ...
    backbone=dict(
        ...
        strides=(2, 2, 2, 1),
        channels=(24, 48, 72, 120),
        block_settings=([[6, 7]] * 6, [[6, 7]] * 8, [[6, 7]] * 10,
                        [[6, 7]] * 10)),
    keypoint_head=dict(
        type='LitePoseHead',
        deconv_setting=[64, 40, 32],
        num_deconv_layers=3,
