...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        bgr_to_rgb=True),
    metainfo=dict(from_file='configs/_base_/datasets/humanart_aic.py'),
    backbone=dict(
        type='HRNet',
        in_channels=3,
        extra=dict(
    ...
    test_cfg=dict(
        ...
        output_keypoint_indices=[
            target for _, target in keypoint_mapping_humanart
        ]))
...
dataset_humanart = dict(
    ...
    pipeline=[
        dict(
            ...
            num_keypoints=19,
            mapping=keypoint_mapping_humanart)
    ],
)
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(from_file='configs/_base_/datasets/humanart_aic.py'),
        datasets=[dataset_humanart, dataset_aic],
