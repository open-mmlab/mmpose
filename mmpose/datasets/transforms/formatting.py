...
=======
                            'raw_ann_info'),
                 extra_mapping_labels: dict = dict(),
>>>>>>> add related transforms
                 pack_transformed=False):
        self.meta_keys = meta_keys
        self.extra_mapping_labels = extra_mapping_labels
    ...
    def transform(self, results: dict) -> dict:
        ...
        # label_mapping_table = self.label_mapping_table.copy()
        # label_mapping_table.update(self.extra_mapping_labels)
        # for key, packed_key in label_mapping_table.items():
    ...
    def __repr__(self) -> str:
        ...
        repr_str += f'extra_mapping_labels={self.extra_mapping_labels}, '
