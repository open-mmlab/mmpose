...
class BottomUpPicDataset(BottomUpBaseDataset):
    """PIC1.0 (company) dataset for bottom-up pose estimation.
    ...
    def __init__(self,
        ...
        self.ann_info['flip_index'] = [
            0, 1, 5, 6, 7, 2, 3, 4, 11, 12, 13, 8, 9, 10, 14
        ]
        ...
        self.sigmas = np.array([
            .26, .26, 1.79, .72, .62, 1.79, .72, .62, 1.07, .83, .89, 1.07, .83, .89,
            .26
        ]) / 10.0
