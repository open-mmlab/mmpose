...
class HandCocoWholeBodyDataset(HandBaseDataset):
    ...
    def __init__(self,
        ...
        self.dataset_name = 'hand_coco_wholebody'
        ...
        for img_id in self.img_ids:
            ...
            for obj in objs:
                for type in ['left', 'right']:
                    ...
                    center, scale = self._xywh2cs(*obj[f'{type}hand_box'][:4],
                                                  1.25)
