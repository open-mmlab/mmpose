...
class Encoder(nn.Module):
    ...
    def __init__(self, in_length, hid_size):
        ...
        self.conv1d = nn.Linear(
            in_features=in_length, out_features=hid_size, bias=True)
...
class Dense(nn.Module):
    ...
    def __init__(self, hid_size=256, mid_size=256, dropout=0.25):
        ...
        self.linear_1 = nn.Linear(
            in_features=hid_size, out_features=mid_size, bias=True)
        self.linear_2 = nn.Linear(
            in_features=mid_size, out_features=hid_size, bias=True)
...
class Decoder(nn.Module):
    ...
    def __init__(self, hid_size, out_length):
        ...
        self.conv1d = nn.Linear(
            in_features=hid_size, out_features=out_length, bias=True)

    def forward(self, input):
        return self.conv1d(input)


class SmoothNetV0(nn.Module):
    """
    ...
    def __init__(self,
                 ...
                 dropout=0.5,
                 mid_size=256):
        super(SmoothNetV0, self).__init__()
        ...
        for i in range(num_block):
            ResidualBlock.append(
                Dense(hid_size=hid_size, mid_size=mid_size, dropout=dropout))
