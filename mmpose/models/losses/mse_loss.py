...
class SymmetryLoss(nn.Module):
    ...
    def forward(self, output, target, target_weight):
        ...
        loss = self.symmetry_loss(heatmaps_pred,
                                heatmaps_gt,)
        return loss
    ...
    def symmetry_loss(self, pred, gt):
        ...
        for permutation in self.symmetry_group:
            ...
            symm_group_losses.append(self.criterion(pred, permutated_gt))
        combined_symm_group_losses = torch.stack(symm_group_losses, dim=-1)
        reduced_loss = torch.mean(combined_symm_group_losses, dim=(1,2))
