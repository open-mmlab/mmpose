...
- [MacaquePose](#macaquepose) \[ [Homepage](http://www2.ehub.kyoto-u.ac.jp/datasets/macaquepose/index.html) \]
...
For [MacaquePose](http://www2.ehub.kyoto-u.ac.jp/datasets/macaquepose/index.html) dataset, images can be downloaded from [download](http://www2.ehub.kyoto-u.ac.jp/datasets/macaquepose/index.html).
