...
TensorBoard is a powerful tool that allows you to visualize the changes in losses during training. To enable TensorBoard visualization, you can either:

- Uncomment the relevant lines in  `$MMPose/configs/_base_/default_runtime.py`
...
- Or manually specify the visualization backend in your configuration as follows:
...
The event file generated by TensorBoard will be save under the experiment log folder specified by `--work-dir`.
