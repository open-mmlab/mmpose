...
- [2D Body Keypoint](/docs/tasks/2d_body_keypoint/data_preparation.md)
- [2D Hand Keypoint](/docs/tasks/2d_hand_keypoint/data_preparation.md)
- [2D WholeBody Keypoint](/docs/tasks/2d_wholebody_keypoint/data_preparation.md)
- [3D Human Mesh Recovery](/docs/tasks/3d_body_mesh/data_preparation.md)
