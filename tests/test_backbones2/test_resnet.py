...
from mmpose.models.backbones2 import ResNet, ResNetV1d
from mmpose.models.backbones2.resnet import (BasicBlock, Bottleneck, ResLayer,
                                             get_expansion)
...
def test_resnet():
    ...
    feat = model(imgs)
    assert len(feat) == 1
    assert feat[-1].shape == (1, 2048, 7, 7)
