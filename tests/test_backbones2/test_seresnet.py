...
from mmpose.models.backbones2 import SEResNet
from mmpose.models.backbones2.resnet import ResLayer
from mmpose.models.backbones2.seresnet import SEBottleneck, SELayer
...
def test_seresnet():
    ...
    assert feat[-1].shape == torch.Size([1, 2048, 7, 7])
