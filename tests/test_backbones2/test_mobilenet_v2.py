...
from mmpose.models.backbones2 import MobileNetV2
from mmpose.models.backbones2.mobilenet_v2 import InvertedResidual
...
def test_mobilenetv2_backbone():
    ...
    assert feat[-1].shape == torch.Size((1, 2560, 7, 7))
    ...
    feat = model(imgs)
    assert isinstance(feat, tuple)
    assert feat[-1].shape == torch.Size((1, 1280, 7, 7))
