...
from mmpose.models.backbones2 import LiteHRNet
from mmpose.models.backbones2.litehrnet import LiteHRModule
from mmpose.models.backbones2.resnet import Bottleneck
...
def test_litehrnet_backbone():
    ...
    assert feat[-1].shape == torch.Size([2, 40, 56, 56])
