...
class TestCOCOMetric(TestCase):
    ...
    def test_init(self):
        ...
        with self.assertRaisesRegex(ValueError,
            ...
            _ = COCOMetric(ann_file=self.ann_file_coco, score_mode='keypoint')
    ...
    def test_topdown_alignment(self):
        ...
        target = {
            'AP': 0.5287458745874587,
            'AP .5': 0.9042904290429042,
            'AP .75': 0.5009900990099009,
            'AP (M)': 0.42475247524752474,
            'AP (L)': 0.6219554455445544,
            'AR': 0.5833333333333333,
            'AR .5': 0.9166666666666666,
            'AR .75': 0.5833333333333334,
            'AR (M)': 0.44000000000000006,
            'AR (L)': 0.6857142857142857,
        }
        ...
        target = {
            'AP': 0.5004950495049505,
            'AP .5': 0.8836633663366337,
            'AP .75': 0.4679867986798679,
            'AP (M)': 0.42475247524752474,
            'AP (L)': 0.5814108910891089,
            'AR': 0.5833333333333333,
            'AR .5': 0.9166666666666666,
            'AR .75': 0.5833333333333334,
            'AR (M)': 0.44000000000000006,
        ...
        target = {
            'AP': 0.17073707370737073,
            'AP .5': 0.25055005500550054,
            'AP .75': 0.10671067106710669,
            'AP (M)': 0.0,
            'AP (L)': 0.29315181518151806,
            'AR': 0.2416666666666666,
            'AR .5': 0.3333333333333333,
            'AR .75': 0.16666666666666666,
            'AR (M)': 0.0,
            'AR (L)': 0.41428571428571426,
        }
