...
class TestSimCCHead(TestCase):
    ...
    def test_loss(self):
        ...
        loss_cfg1 = dict(
            type='KLLossWithLabelSmoothing', use_target_weight=True)

        loss_cfg2 = dict(
            type='KLLossWithLabelSmoothing',
            label_smoothing=0.2,
        ...
        for loss_cfg in [loss_cfg1, loss_cfg2]:
            head = SimCCHead(
                in_channels=[16, 32],
                out_channels=17,
                input_size=(192, 256),
